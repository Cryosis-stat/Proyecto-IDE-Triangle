...
public class Main extends javax.swing.JFrame {
    ...
    /**
     * Opens a file chooser dialog, used in the "Open" options.
     *
     * @return The JFileChooser dialog object.
     */
    private JFileChooser drawFileChooseTAM() {
        JFileChooser chooser = new JFileChooser();
        ExampleFileFilter filter = new ExampleFileFilter();
        filter.setDescription("TAM files");
    ...
    private void initComponents() {
        ...
        compileFileMenuItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F7, 0));
        compileFileMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/Icons/iconTriangleCompileFile.gif"))); // NOI18N
        compileFileMenuItem.setText("Compile to file");
        compileFileMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                compileFileMenuItemActionPerformed(evt);
            }
        });
        ...
        triangleMenu.add(runFileMenuItem);
     ...
     * determining if the file contents have changed, activating the "Save"
     * button and menu option.
     */
    ...
    InternalFrameListener delegateInternalFrame = new InternalFrameListener() {
        ...
        /**
         * Every time a frame is focused/activated, some buttons can be enabled
         * (e.g. "Save", "Cut", "Copy", "Paste").
         */
        ...
        /**
         * Every time a frame is closed, some buttons can be disabled (e.g.
         * "Save", "Cut", "Copy", "Paste").
         */
    ...
    /**
     * Used to redirect the console input - enables the "Console Input" text
     * box.
     */
    ...
    /**
     * Used to redirect the console input - writes the user input in the
     * console.
     */
    ...
    /**
     * Used to control running programs - only one TAM program can be run at
     * once
     */
    ...
    javax.swing.JMenuItem compileFileMenuItem;
    ...
    javax.swing.JMenuItem runFileMenuItem;
    ...
    /**
     * ClipboardOwner Class Internal clipboard management class, uses the
